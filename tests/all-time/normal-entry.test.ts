...
test("normal entry preview protects lower-is-better records and describes Climbers", () => {
  ...
  assert.match(page, /preview_all_time_verified_period_entry_v2/)
  assert.match(page, /record_all_time_verified_period_entry_v2/)
...
test("final intake is one-player, authoritative-par, and session-based", () => {
  ...
  assert.match(page, /Posting\/source order/)
