...
export function RecordsIcon({ kind }: { kind: "single" | "combined" | "import" | "home" | "entry" | "history" | "climbers" | "backfill" }) {
  const paths = {
    ...
    backfill: <><path d="M4 7h16M4 12h10M4 17h7"/><path d="m17 14 3 3-3 3"/><path d="M20 17h-6"/></>,
  }
