...
test("admin Course Challenge review queue exposes pending count and review controls", () => {
  const admin = read("app/admin/course-challenges/page.tsx")
  const api = read("app/api/admin/course-challenges/route.ts")
  const dashboard = read("app/admin/page.tsx")
  assert.match(admin, /Course Challenge Review Queue/)
  assert.match(admin, /Pending submissions: \{pendingCount\}/)
  ...
  assert.match(api, /searchParams\.get\("summary"\)/)
