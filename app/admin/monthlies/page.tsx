...
export default function MonthliesAdminPage() {
  return (
    <main style={page}>
      <h1 style={title}>Monthlies Admin</h1>
      <p style={subtitle}>Manage the current Monthlies membership without changing historical Monthly results.</p>
      <div style={grid}>
        <Link href="/admin/monthlies/players" style={card}>
          <strong>Players</strong>
          <span>View and manage the current Monthlies members.</span>
        </Link>
        <Link href="/monthlies" style={card}>
          <strong>Public Results</strong>
          <span>View historical Monthly results and divisions.</span>
        </Link>
