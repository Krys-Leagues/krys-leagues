...
export default function SpicyAdminPage() {
  return (
    <main style={page}>
      <h1 style={title}>Spicy League Admin</h1>
      <p style={subtitle}>Manage Spicy league tracking and events.</p>

      <div style={grid}>
        <Link href="/admin/spicy/setup" style={card}>
          <strong>Setup New Season</strong>
          <span>Create or prepare a new Spicy season.</span>
        </Link>
