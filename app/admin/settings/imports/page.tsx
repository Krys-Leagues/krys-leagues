...
export default function ImportSettingsPage() {
  return (
    <main style={page}>
      <h1 style={title}>Import Settings</h1>

      <p style={subtitle}>
        Configure imports for players, schedules, scores, and league data.
      </p>
      ...
      <div style={grid}>
        <section style={card}>
          ...
          <span>
            Configure player import options and validation.
          </span>
        </section>
        ...
        <section style={card}>
          ...
          <span>
            Import seasons, schedules, standings, and league information.
          </span>
        </section>
        ...
        <section style={card}>
          ...
          <span>
            Manage CSV templates and future import formats.
          </span>
        </section>
