...
export default function LoggingSettingsPage() {
  return (
    <main style={page}>
      <h1 style={title}>Logging Settings</h1>

      <p style={subtitle}>
        Configure application logging, diagnostics, and event history.
      </p>
      ...
      <div style={grid}>
        ...
        <section style={card}>
          ...
          <span>
            Review application errors and exceptions.
          </span>
        </section>
        ...
        <section style={card}>
          ...
          <span>
            Configure administrator activity logging.
          </span>
        </section>
        ...
        <section style={card}>
          ...
          <span>
            Configure debugging and diagnostic information.
          </span>
        </section>
