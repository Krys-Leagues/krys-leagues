...
export default function SystemSettingsPage() {
  return (
    <main style={page}>
      ...
      <p style={subtitle}>
        Configure core application behavior, maintenance, and system-wide options.
      </p>
      ...
      <div style={grid}>
        ...
        <section style={card}>
          ...
          <span>
            Configure maintenance windows and system availability.
          </span>
        </section>
        ...
        <section style={card}>
          ...
          <span>
            View application version and environment information.
          </span>
        </section>
        ...
        <section style={card}>
          ...
          <span>
            Review system status and diagnostics.
          </span>
        </section>
