...
export default function SecuritySettingsPage() {
  return (
    <main style={page}>
      <h1 style={title}>Security Settings</h1>

      <p style={subtitle}>
        Configure authentication, administrator security, and system protection.
      </p>
      ...
      <div style={grid}>
        <section style={card}>
          ...
          <span>
            Configure administrator login methods.
          </span>
        </section>
        ...
        <section style={card}>
          ...
          <span>
            Review security events and administrator activity.
          </span>
        </section>
