...
export default function MatchSeasonPage() {
  ...
  async function createSeason() {
    ...
    if (createError || !createdSeason) {
      ...
      await logActivity({
        userType: "admin",
        action: "Create Match Season Failed",
        status: "error",
        leagueType: LEAGUE_TYPE,
        page: "/admin/match/season",
        details: {
          seasonNumber: number,
          divisionCount: count,
          startDate,
      ...
      setMessage(`Match season was not created: ${errorMessage}`)
      setSaving(false)
      return
    }
    ...
    router.push(`/admin/match/setup?${setupParams.toString()}`)
  }
  ...
  return (
    <main style={page}>
      <div style={container}>
        ...
        <h1 style={title}>Match Season</h1>
        <p style={subtitle}>
          Create and manage Match Play seasons inside the Match hub.
        </p>

        <section style={panel}>
          <h2 style={sectionTitle}>Create Match Season</h2>
          ...
          <p style={helperText}>
            This creates one Match season row with a draft roster containing
          ...
          >
            {saving ? "Creating Match Season..." : "Create Match Season"}
          </button>
        ...
        <section style={panel}>
          ...
          <p style={helperText}>
            Select a managed Match season and open one of its roster divisions.
          </p>

          <button
            type="button"
            onClick={() => router.push("/admin/match/season/edit")}
