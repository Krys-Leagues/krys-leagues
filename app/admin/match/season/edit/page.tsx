...
export default function EditCurrentMatchSeasonPage() {
      ...
      setDetailsMessage(
        `${
          resizeCompleted
            ...
            : "Match season changes were not saved: "
        }${
  ...
  return (
    <main style={page}>
      <div style={container}>
        <nav style={topBar} aria-label="Match admin navigation">
          <Link href="/admin/match/season" style={backButtonPrimary}>
            ← Match Season
          </Link>
          <Link href="/admin/match" style={backButtonSecondary}>
            ← Match Hub
          </Link>
        </nav>
        ...
        <h1 style={title}>
          {selectedSeason
            ? `Edit Match Season ${selectedSeason.season_number}`
            : "Edit Current Match Season"}
        </h1>
        <p style={subtitle}>
        ...
        <section style={panel}>
          ...
          {loading ? (
            <p style={mutedText}>Loading Match seasons...</p>
          ) : errorMessage ? (
        ...
        {!loading && !errorMessage && selectedSeason && (
          <>
            ...
            <section style={panel}>
              ...
              <p style={sectionDescription}>
                Division changes are made on the existing Match setup page.
              </p>

              {!selectedRoster ? (
                <p role="alert" style={errorText}>
                  No draft, approved, or locked roster was found for Match Season{" "}
                  ...
                  <div style={divisionList}>
                    {divisions.map((divisionNumber) => (
                      <div key={divisionNumber} style={divisionRow}>
                        <span style={divisionName}>Match D{divisionNumber}</span>
                        <button
                          type="button"
