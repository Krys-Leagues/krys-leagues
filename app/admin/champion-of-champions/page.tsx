...
export default function ChampionOfChampionsAdminPage() {
  return (
    <main style={page}>
      <h1 style={title}>Champion of Champions Admin</h1>
      <p style={subtitle}>Manage Champion of Champions setup, results, and active matches.</p>

      <div style={grid}>
        <Link href="/admin/champion-of-champions/setup" style={card}>
          <strong>Setup Event</strong>
          <span>Create or prepare a Champion of Champions event.</span>
        </Link>
