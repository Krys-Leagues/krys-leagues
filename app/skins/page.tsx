  ...
  return (
    <main style={page}>
      <div style={container}>
        ...
        <section style={hero}>
          <h1 style={title}>💰 Skins</h1>

          <p style={subtitle}>
            View Skins standings, results, player totals, and league history.
          </p>
        </section>
        ...
        <div style={grid}>
          ...
          <section style={card}>
            <h2>✅ Results</h2>
            <p>View completed Skins rounds and winners.</p>
          </section>

          <Link href="/players" style={card}>
            <h2>👤 Player Totals</h2>
            <p>View player profiles, Skins totals, and history.</p>
          </Link>

          <Link href="/records" style={card}>
            <h2>🏆 Skins Records</h2>
            <p>View Skins records and achievements.</p>
          </Link>
        </div>
      </div>
    </main>
