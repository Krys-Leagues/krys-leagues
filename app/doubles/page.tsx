  ...
  return (
    <main style={page}>
      <div style={container}>
        ...
        <section style={hero}>
          <h1 style={title}>👥 Doubles</h1>

          <p style={subtitle}>
            View current Doubles matches, standings, records, teams, and player
            history.
          </p>
        </section>
        ...
        <div style={grid}>
          <Link href="/matches" style={card}>
            ...
            <p>
              Select a Doubles division and season to view schedules, scores,
          ...
          <Link href="/players" style={card}>
            <h2>👥 Teams & Players</h2>
            <p>View player profiles and Doubles history.</p>
          </Link>

          <Link href="/records" style={card}>
            <h2>🏆 League Records</h2>
            <p>View Doubles records and achievements.</p>
          </Link>
        </div>
      </div>
    </main>
