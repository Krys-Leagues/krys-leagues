...
import type { ArizonaCourseCode, ArizonaIdentityDecision } from "@/lib/all-time/arizona/types"
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const courseCode = form.get("courseCode") as ArizonaCourseCode
    ...
    const parsed = parseArizonaCourseCsv(await file.text(), courseCode, file.name)
